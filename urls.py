...
urlpatterns = patterns('',
	...
	url(r'^accounts/recover_password/$', 'karteikarten.login.RecoverPasswordForm', name = 'recover-password-form'),
	url(r'^accounts/recover_password/request/$', 'karteikarten.login.RecoverPasswordSubmit', name = 'recover-password-submit'),
	url(r'^accounts/recover_password/reset/$', 'karteikarten.login.RecoverResetPasswordForm', name = 'recover-reset-password-form'),
	url(r'^accounts/recover_password/reset/request/$', 'karteikarten.login.RecoverResetPasswordSubmit', name = 'recover-reset-password-submit'),
	...
	url(r'^edit/new/request/$', 'karteikarten.edit.NewSetSubmit', name = 'new-set-submit'),
	url(r'^edit/(?P<set_id>\d+)/$', 'karteikarten.edit.EditSet', name = 'edit-set'),
	url(r'^edit/(?P<set_id>\d+)/request/$', 'karteikarten.edit.EditSetSubmit', name = 'edit-set-submit'),
	...
	url(r'^edit/(?P<set_id>\d+)/boxes/new/request/$', 'karteikarten.edit.NewBoxSubmit', name = 'new-box-submit'),
	url(r'^edit/(?P<set_id>\d+)/boxes/(?P<box_id>\d+)/$', 'karteikarten.edit.EditBox', name = 'edit-box'),
	url(r'^edit/(?P<set_id>\d+)/boxes/(?P<box_id>\d+)/request/$', 'karteikarten.edit.EditBoxSubmit', name = 'edit-box-submit'),
	...
	url(r'^edit/(?P<set_id>\d+)/cards/new/request/$', 'karteikarten.edit.NewCardSubmit', name = 'new-card-submit'),
	url(r'^edit/(?P<set_id>\d+)/cards/(?P<card_id>\d+)/$', 'karteikarten.edit.EditCard', name = 'edit-card'),
	url(r'^edit/(?P<set_id>\d+)/cards/(?P<card_id>\d+)/request/$', 'karteikarten.edit.EditCardSubmit', name = 'edit-card-submit'),

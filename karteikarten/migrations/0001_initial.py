...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		...
		# Adding model 'CardBox'
		db.create_table('karteikarten_cardbox', (
			('name', self.gf('django.db.models.fields.CharField')(max_length=60)),
			('level', self.gf('django.db.models.fields.IntegerField')()),
			('parent_card_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['karteikarten.CardSet'])),
		...
		db.create_table('karteikarten_card', (
			...
			('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
			('current_box', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['karteikarten.CardBox'], null=True, blank=True)),
